...
declare -a manual_seed=(52)
declare -a sample_complexity=(10.0)
declare -a n_features=(1024)
declare -a n_hidden=(1000)
declare -a lr=(0.0001)
...
declare -a tau=(2)
declare -a K=(0.67449)
declare -a activation=("relu-quadratic")
...
srun python -u /home/dmitriev/spoc_master_project/main.py \
 --root_dir 15_07_small_teacher \
 --labels quadratic \
 --teacher_n_hidden 1 \
 --start_seed ${manual_seed[s]} \
 --psgd_adaptive_bs True \
 --reverse_mult_by_sqrt True \
 ...
 --use_nesterov False \
 --fix_teacher_change_data True --change_teacher True \
 --loss ${loss[q]} \
