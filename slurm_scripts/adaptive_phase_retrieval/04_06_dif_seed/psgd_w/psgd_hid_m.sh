...
declare -a sample_complexity=(1.0 1.5 1.7 2.0 2.3 2.5 2.7 3.0 3.3 3.5 4.0 4.5)
...
srun python -u /home/dmitriev/spoc_master_project/main.py \
 --root_dir 12_06_phase_retrieval \
 --labels quadratic \
 ...
 --use_nesterov True --fix_teacher_change_data True \
 --loss ${loss[q]} \
