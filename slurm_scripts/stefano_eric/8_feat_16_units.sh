...
declare -a sample_complexity=(2.0 2.5)
declare -a n_features=(8)
declare -a n_hidden=(16 32)
declare -a lr=(0.01)
...
for ((t=0;t<${#tau[@]};++t)); do
srun python -u /home/dmitriev/spoc_master_project/main.py --root_dir stefano_eric --start_seed ${manual_seed[s]} \
 ...
 --verbose_freq 10 --optimizer ${optimizer[o]} --n_epochs ${n_epochs[l]} --lr ${lr[l]} --train_threshold 1e-8 \
