...
declare -a lr=(0.005 0.01 0.02)
declare -a n_epochs=(1600 800 400)
declare -a momentum=(0.0)
declare -a batch_size=(512)
declare -a optimizer=("sgd")
declare -a tau=(2)
declare -a K=(0.67449)
declare -a activation=("linear")
declare -a second_layer_activation=("symmetric-door-absolute")
...
srun python -u /home/dmitriev/spoc_master_project/main.py \
 --root_dir 13_05_symm_door_hidden \
