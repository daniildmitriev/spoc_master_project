...
declare -a lr=(0.12 0.15)
declare -a n_epochs=(10000 10000)
...
srun python -u /home/dmitriev/spoc_master_project/main.py --root_dir gd_1024_test --start_seed ${manual_seed[i]} \
 ...
 --verbose_freq 100 --optimizer ${optimizer[p]} --n_epochs ${n_epochs[m]} --lr ${lr[m]} --threshold 1e-10 \
 --gradient_threshold 1e-10 --test_threshold 1e-3 --n_runs 1
done
done
done
done
