...
declare -a sample_complexity=(2.5)
declare -a n_features=(1024)
declare -a n_hidden=(10)
declare -a lr=(0.02 0.05 0.1)
declare -a n_epochs=(10000 10000 10000)
...
srun python -u /home/dmitriev/spoc_master_project/main.py --root_dir gd_1024_test --start_seed ${manual_seed[i]} \
 ...
 --verbose_freq 100 --optimizer ${optimizer[p]} --n_epochs ${n_epochs[m]} --lr ${lr[m]} --threshold 1e-6 \
 --weight_decay 1e-1 --gradient_threshold 1e-10 --test_threshold 1e-3 --n_runs 5
done
done
done
done
