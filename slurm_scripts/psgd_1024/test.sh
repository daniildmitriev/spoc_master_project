...
for ((t=0;t<${#tau[@]};++t)); do
srun python -u /home/dmitriev/spoc_master_project/main.py --root_dir test --start_seed ${manual_seed[s]} \
 ...
 --gradient_threshold 5e-5 --test_threshold 1e-3 --n_runs 5 --persistence_time ${tau[t]}
done
done
done
done
