...
declare -a sample_complexity=(4.0 5.0)
declare -a n_features=(128)
...
srun python -u /home/dmitriev/spoc_master_project/main.py --root_dir sgd --start_seed ${manual_seed[i]} \
 ...
 --verbose_freq 500 --optimizer ${optimizer[t]} --n_epochs ${n_epochs[m]} --lr ${lr[m]} --threshold 1e-5
done
done
done
done
