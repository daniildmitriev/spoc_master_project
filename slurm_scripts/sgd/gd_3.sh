...
for ((t=0;t<${#batch_size[@]};++p)); do
srun python -u /home/dmitriev/spoc_master_project/main.py --root_dir sgd \
 ...
 --verbose_freq 500 --optimizer ${optimizer[p]} --n_epochs ${n_epochs[m]} --lr ${lr[m]} --threshold 1e-8
done
done
done
done
