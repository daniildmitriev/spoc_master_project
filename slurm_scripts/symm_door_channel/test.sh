...
declare -a lr=(0.001 0.005)
declare -a n_epochs=(2000 2000)
...
for ((q=0;q<${#loss[@]};++q)); do
srun python -u /home/dmitriev/spoc_master_project/main.py --root_dir test_run --start_seed ${manual_seed[s]} \
 ...
 --gradient_threshold 5e-10 --test_threshold 1e-3 --n_runs 2 --persistence_time ${tau[t]} \
